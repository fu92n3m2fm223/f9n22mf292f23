...
if game.PlaceId == Games.FreedomWar.Campaign then
	...
	elseif Executor == "Wave" or Executor == "Synapse Z" or Executor == "Rebel" or Executor == "AWP" then
...
if game.PlaceId == Games.Shinden.Main then
	if Executor == "Wave" or Executor == "Synapse Z" or Executor == "Rebel" or Executor == "AWP" then
